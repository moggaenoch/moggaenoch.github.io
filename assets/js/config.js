...
(() => {
  ...
  // ✅ Local backend (edit if your local port differs)
  const DEV_API_BASE_URL = "http://localhost:5000/api";

  // ✅ Render backend (REPLACE THIS with your real Render API base)
  // Example:
  // const PROD_API_BASE_URL = "https://jubahomez-api.onrender.com/api";
  const PROD_API_BASE_URL = "https://YOUR-RENDER-SERVICE.onrender.com/api";
